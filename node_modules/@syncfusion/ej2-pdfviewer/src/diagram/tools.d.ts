...
import { PdfViewer, PdfViewerBase } from '../pdfviewer';
...
export declare class ToolBase {
    ...
    protected updateSize(shape: SelectorModel | PdfAnnotationBaseModel, startPoint: PointModel, endPoint: PointModel, corner: string, initialBounds: Rect, angle?: number): Rect;
...
export declare class PolygonDrawingTool extends ToolBase {
    ...
    mouseMove(args: MouseEventArgs): boolean;
    /**   @private  */
    mouseUp(args: MouseEventArgs, isDoubleClineck?: boolean): void;
    /**   @private  */
    mouseWheel(args: MouseEventArgs): void;
    /**   @private  */
    endAction(): void;
