...
import { SortOptions } from './../../workbook/index';
...
export declare class Spreadsheet extends Workbook implements INotifyPropertyChanged {
     ...
     * @hidden
     */
    getRow(rowIndex: number, table?: HTMLTableElement): HTMLTableRowElement;
    /**
     ...
     */
    sort(sortOptions?: SortOptions, range?: string): void;
    /** @hidden */
    ...
    /** @hidden */
    setRowHeight(sheetIndex: number, rowIndex: number, height: number): void;
    /** @hidden */
