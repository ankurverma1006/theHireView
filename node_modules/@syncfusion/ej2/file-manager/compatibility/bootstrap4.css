...
.e-control.e-filemanager .e-fe-icon, .e-control.e-filemanager .e-list-icon {
  background-repeat: no-repeat;
}

.e-control.e-filemanager .e-fe-docx, .e-control.e-filemanager .e-fe-doc {
...
.e-control.e-filemanager .e-fe-pptx, .e-control.e-filemanager .e-fe-ppt {
...
.e-control.e-filemanager .e-fe-xlsx, .e-control.e-filemanager .e-fe-xls {
...
.e-control.e-filemanager .e-fe-pdf {
...
.e-control.e-filemanager .e-fe-image {
...
.e-control.e-filemanager .e-fe-rar {
...
.e-control.e-filemanager .e-fe-zip {
...
.e-control.e-filemanager .e-fe-txt {
...
.e-control.e-filemanager .e-fe-music {
...
.e-control.e-filemanager .e-fe-video {
...
.e-control.e-filemanager .e-fe-js {
...
.e-control.e-filemanager .e-fe-css {
...
.e-control.e-filemanager .e-fe-html {
...
.e-control.e-filemanager .e-fe-php {
...
.e-control.e-filemanager .e-fe-exe {
...
.e-control.e-filemanager .e-fe-msi {
...
.e-control.e-filemanager .e-fe-unknown {
...
.e-control.e-filemanager .e-fe-rtf {
...
.e-control.e-filemanager .e-fe-xml {
...
.e-control.e-filemanager .e-fe-folder {
...
.e-control.e-filemanager .e-fe-locked > .e-text-content .e-fe-folder, .e-control.e-filemanager .e-fe-locked > .e-fe-grid-icon .e-fe-folder {
...
.e-control.e-filemanager .e-address .e-address-list-item .e-icons::before {
  content: '\e76a';
}

.e-control.e-filemanager .e-fe-open::before, .e-control.e-fe-popup .e-fe-open::before {
  content: '\e70f';
}

.e-control.e-filemanager .e-fe-cut::before, .e-control.e-fe-popup .e-fe-cut::before {
  content: '\e73f';
}

.e-control.e-filemanager .e-fe-copy::before, .e-control.e-fe-popup .e-fe-copy::before {
  content: '\e77b';
}

.e-control.e-filemanager .e-fe-paste::before, .e-control.e-fe-popup .e-fe-paste::before {
  content: '\e739';
}

.e-control.e-filemanager .e-fe-delete::before, .e-control.e-fe-popup .e-fe-delete::before {
  content: '\e773';
}

.e-control.e-filemanager .e-fe-rename::before, .e-control.e-fe-popup .e-fe-rename::before {
  content: '\e751';
}

.e-control.e-filemanager .e-fe-newfolder::before, .e-control.e-fe-popup .e-fe-newfolder::before {
  content: '\e76e';
}

.e-control.e-filemanager .e-fe-refresh::before, .e-control.e-fe-popup .e-fe-refresh::before {
  content: '\e710';
}

.e-control.e-filemanager .e-fe-upload::before, .e-control.e-fe-popup .e-fe-upload::before {
  content: '\e769';
}

.e-control.e-filemanager .e-fe-download::before, .e-control.e-fe-popup .e-fe-download::before {
  content: '\e75d';
}

.e-control.e-filemanager .e-fe-grid::before, .e-control.e-fe-popup .e-fe-grid::before {
  content: '\e72a';
}

.e-control.e-filemanager .e-fe-large::before, .e-control.e-fe-popup .e-fe-large::before {
  content: '\e717';
}

.e-control.e-filemanager .e-fe-select::before, .e-control.e-fe-popup .e-fe-select::before {
  content: '\e77d';
}

.e-control.e-filemanager .e-fe-details::before, .e-control.e-fe-popup .e-fe-details::before {
  content: '\e729';
}

.e-control.e-filemanager .e-fe-sort::before, .e-control.e-fe-popup .e-fe-sort::before {
  content: '\e741';
}

.e-control.e-filemanager .e-fe-search::before, .e-control.e-fe-popup .e-fe-search::before {
  content: '\e724';
}

.e-control.e-filemanager .e-fe-clear::before, .e-control.e-fe-popup .e-fe-clear::before {
  content: '\e745';
}

.e-control.e-filemanager .e-fe-breadcrumb::before, .e-control.e-fe-popup .e-fe-breadcrumb::before {
  content: '\e71b';
}

.e-control.e-filemanager .e-fe-drop-in::before, .e-control.e-fe-popup .e-fe-drop-in::before {
  content: '\e755';
}

.e-control.e-filemanager .e-fe-drop-out::before, .e-control.e-fe-popup .e-fe-drop-out::before {
  content: '\e7e8';
}

.e-control.e-filemanager .e-fe-no-drop::before, .e-control.e-fe-popup .e-fe-no-drop::before {
  content: '\e797';
}

.e-control.e-filemanager .e-toolbar .e-hor-nav .e-popup-up-icon::before, .e-control.e-fe-popup .e-toolbar .e-hor-nav .e-popup-up-icon::before {
  content: '\e781';
}

.e-control.e-filemanager .e-toolbar .e-hor-nav .e-popup-down-icon::before, .e-control.e-fe-popup .e-toolbar .e-hor-nav .e-popup-down-icon::before {
  content: '\e781';
}

.e-control.e-filemanager.e-fe-m-filter .e-fe-search::before, .e-control.e-fe-popup.e-fe-m-filter .e-fe-search::before {
  content: '\e728';
}

.e-control.e-fe-popup .e-fe-dot::before {
  content: '\e718';
}

.e-control.e-fe-popup .e-fe-tick::before {
  content: '\e718';
}

.e-controlejs-filemanager {
  display: block;
}

.e-control.e-filemanager {
...
.e-control.e-filemanager .e-blur {
  opacity: .5;
}

.e-control.e-filemanager .e-display-none {
  display: none;
}

.e-control.e-filemanager.e-fe-drop, .e-control.e-filemanager.e-fe-drop .e-treeview .e-text-content, .e-control.e-filemanager.e-fe-drop .e-treeview .e-fullrow, .e-control.e-filemanager.e-fe-drop .e-address .e-address-list-item:last-child .e-list-text, .e-control.e-filemanager.e-fe-drop .e-grid .e-columnheader {
  cursor: grab;
}

.e-control.e-filemanager.e-no-drop {
  cursor: no-drop;
}

.e-control.e-filemanager .e-toolbar {
  border-bottom-style: solid;
  border-width: 0 0 1px;
}

.e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn {
  border: 0;
  box-shadow: none;
  font-weight: 400;
  height: calc(100% - 2px);
...
.e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn .e-btn-icon.e-icons:not(.e-icon-left):not(.e-icon-right) {
  padding: 0;
}

.e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn .e-btn-icon.e-icons.e-caret {
  font-size: 8px;
  padding: 0 8px;
}

.e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn .e-tbar-btn-text.e-tbar-ddb-text {
  padding-right: 0;
}

.e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn.e-active {
  border: 0;
  padding: 1 2.5px;
}

.e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn:hover {
  border: 0;
  padding: 1 2.5px;
}

.e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn:focus {
  border: 0;
  padding: 1 2.5px;
}

.e-control.e-filemanager .e-toolbar .e-toolbar-pop .e-toolbar-item .e-dropdown-btn .e-icons.e-caret {
  font-size: 8px;
  min-width: 0;
  padding: 0 8px;
}

.e-control.e-filemanager .e-toolbar .e-toolbar-pop .e-toolbar-item .e-dropdown-btn .e-tbar-btn-text.e-tbar-ddb-text {
  padding-right: 0;
}

.e-control.e-filemanager .e-toolbar .e-toolbar-pop {
  width: -webkit-max-content;
  width: max-content;
}

.e-control.e-filemanager .e-treeview > .e-ul {
  overflow: initial;
  padding-left: 8px;
}

.e-control.e-filemanager .e-treeview .e-list-parent {
  margin-bottom: 0;
  margin-top: 0;
}

.e-control.e-filemanager .e-treeview .e-list-parent .e-list-item {
  padding-bottom: 0;
  padding-top: 0;
}

.e-control.e-filemanager .e-treeview .e-list-parent .e-list-item .e-fullrow {
  height: 34px;
}

.e-control.e-filemanager .e-treeview .e-list-parent .e-list-item .e-list-text {
  height: 32px;
  line-height: 32px;
}

.e-control.e-filemanager .e-treeview .e-list-parent .e-list-item.e-fe-drop-folder > .e-fullrow {
  border: 1px solid;
  box-sizing: border-box;
}

.e-control.e-filemanager .e-treeview .e-text-content {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
}

.e-control.e-filemanager .e-treeview .e-list-text {
  display: initial;
}

.e-control.e-filemanager .e-splitter {
  border-width: 0;
}

.e-control.e-filemanager .e-splitter .e-split-bar .e-resize-handler {
  display: none;
}

.e-control.e-filemanager .e-splitter .e-display-none {
  display: none;
}

.e-control.e-filemanager .e-address {
  border-bottom: 1px solid;
  height: 34px;
  position: relative;
}

.e-control.e-filemanager .e-address .e-fe-breadcrumb.e-icons {
  padding-bottom: 6px;
}

.e-control.e-filemanager .e-address .e-search-wrap {
  float: right;
...
.e-control.e-filemanager .e-address .e-search-wrap .e-input-group {
  border-bottom-width: 1px;
  height: 30px;
  margin: 0;
}

.e-control.e-filemanager .e-address .e-search-wrap .e-input-group .e-input {
  margin: -2px 0 0 24px;
  padding: 0;
}

.e-control.e-filemanager .e-address .e-search-wrap .e-input-group .e-clear-icon {
  margin: 0;
}

.e-control.e-filemanager .e-address .e-fe-search {
  font-size: 14px;
  margin: 3px 0;
  padding: 5px;
  position: absolute;
...
.e-control.e-filemanager .e-address .e-fe-search::before {
  display: inline-block;
}

.e-control.e-filemanager .e-address .e-addressbar-ul {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
  list-style: none;
...
.e-control.e-filemanager .e-address .e-addressbar-ul .e-breadcrumb-menu {
  display: inline;
}

.e-control.e-filemanager .e-address .e-addressbar-ul .e-breadcrumb-menu .e-breadcrumb-submenu {
  height: 26px;
}

.e-control.e-filemanager .e-address .e-list-text {
  cursor: pointer;
  font-size: 14px;
  line-height: 30px;
  padding: 4px 4px 5px;
...
.e-control.e-filemanager .e-address .e-list-text:hover {
  text-decoration: underline;
}

.e-control.e-filemanager .e-address .e-address-list-item {
  display: inline-block;
  height: 29px;
}

.e-control.e-filemanager .e-address .e-address-list-item:last-child .e-list-text {
  cursor: default;
}

.e-control.e-filemanager .e-address .e-address-list-item:last-child .e-list-text:hover {
  text-decoration: none;
}

.e-control.e-filemanager .e-address .e-address-list-item .e-icons {
  font-size: 8px;
  margin: 0 4px;
}
...
.e-control.e-filemanager .e-grid {
  border-width: 0;
  float: left;
}

.e-control.e-filemanager .e-grid .e-checkbox-wrapper .e-frame {
  border-width: 1px;
  line-height: 10px;
}

.e-control.e-filemanager .e-grid .e-spin-show {
  display: none;
}

.e-control.e-filemanager .e-grid .e-gridcontent tr.e-emptyrow td.e-lastrowcell:first-child:empty {
  height: 0;
  padding: 0;
}

.e-control.e-filemanager .e-grid .e-gridheader {
  border-width: 0 1px 1px;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-headercell {
  height: 32px;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-headercell.e-fe-grid-icon .e-sortfilterdiv {
  margin-right: 0;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-headercell .e-headertext {
  font-size: 14px;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-headercell .e-rcursor {
  border: 0;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-checkbox-wrapper {
  visibility: hidden;
}

.e-control.e-filemanager .e-grid .e-gridheader:hover .e-checkbox-wrapper, .e-control.e-filemanager .e-grid .e-gridheader .e-active .e-checkbox-wrapper {
  visibility: visible;
}

.e-control.e-filemanager .e-grid.e-headercheck .e-gridheader .e-headercontent .e-checkbox-wrapper {
  visibility: visible;
}

.e-control.e-filemanager .e-grid .e-content {
  overflow-y: auto !important;
}

.e-control.e-filemanager .e-grid .e-content .e-table {
  border-spacing: 0;
}

.e-control.e-filemanager .e-grid .e-content .e-rowcell {
  border: 0;
  font-size: 12px;
}

.e-control.e-filemanager .e-grid .e-content .e-rowcell .e-fe-text {
  font-size: 13px;
}

.e-control.e-filemanager .e-grid .e-content tr.e-row.e-fe-drop-folder .e-rowcell:first-child {
  box-shadow: 1px 0 0 1px #007bff inset;
}

.e-control.e-filemanager .e-grid .e-content tr.e-row.e-fe-drop-folder .e-rowcell:last-child {
  box-shadow: -1px 0 0 1px #007bff inset;
}

.e-control.e-filemanager .e-grid .e-content tr.e-row.e-fe-drop-folder .e-rowcell {
  box-shadow: 0 2px 0 -1px #007bff inset, 0 -2px 0 -1px #007bff inset;
}

.e-control.e-filemanager .e-grid .e-empty {
  min-width: 200px;
}

.e-control.e-filemanager .e-grid .e-empty-content {
  font-size: 20px;
  margin: 0 auto;
  padding: 8px;
  text-align: center;
...
.e-control.e-filemanager .e-grid .e-empty-icon {
  height: 52px;
  margin: 0 auto;
  width: 52px;
}

.e-control.e-filemanager .e-grid .e-empty-inner-content {
  font-size: 14px;
  margin: 0 auto;
  opacity: 0.5;
  padding: 6px;
...
.e-control.e-filemanager .e-grid .e-gridpopup {
  display: none !important;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-emptyrow, .e-control.e-filemanager .e-grid .e-gridcontent .e-emptyrow {
  display: none;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-fe-checkbox, .e-control.e-filemanager .e-grid .e-gridcontent .e-fe-checkbox {
  overflow: inherit;
  padding-left: 8px;
  padding-right: 0;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-fe-grid-icon, .e-control.e-filemanager .e-grid .e-gridcontent .e-fe-grid-icon {
  padding: 0 0 0 12px;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-fe-grid-icon .e-headercelldiv, .e-control.e-filemanager .e-grid .e-gridcontent .e-fe-grid-icon .e-headercelldiv {
  text-overflow: unset;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-fe-grid-icon + .e-rowcell, .e-control.e-filemanager .e-grid .e-gridheader .e-fe-grid-icon + .e-headercell, .e-control.e-filemanager .e-grid .e-gridcontent .e-fe-grid-icon + .e-rowcell, .e-control.e-filemanager .e-grid .e-gridcontent .e-fe-grid-icon + .e-headercell {
  padding-left: 0;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-fe-grid-icon + .e-rowcell.e-fe-grid-name, .e-control.e-filemanager .e-grid .e-gridheader .e-fe-grid-icon + .e-headercell.e-fe-grid-name, .e-control.e-filemanager .e-grid .e-gridcontent .e-fe-grid-icon + .e-rowcell.e-fe-grid-name, .e-control.e-filemanager .e-grid .e-gridcontent .e-fe-grid-icon + .e-headercell.e-fe-grid-name {
  padding-left: 6px;
}

.e-control.e-filemanager .e-grid .e-row .e-checkbox-wrapper {
  visibility: hidden;
}

.e-control.e-filemanager .e-grid .e-row.e-focused {
  box-shadow: none;
}

.e-control.e-filemanager .e-grid .e-row.e-focused td {
  box-shadow: inset 0 1px 0 0 #66afe9, inset 0 -1px 0 0 #66afe9;
}

.e-control.e-filemanager .e-grid .e-row.e-focused td:first-child {
  box-shadow: inset 1px 1px 0 0 #66afe9, inset 1px -1px 0 0 #66afe9;
}

.e-control.e-filemanager .e-grid .e-row.e-focused td:last-child {
  box-shadow: inset -1px 1px 0 0 #66afe9, inset -1px -1px 0 0 #66afe9;
}

.e-control.e-filemanager .e-grid .e-row:hover .e-checkbox-wrapper, .e-control.e-filemanager .e-grid .e-row .e-active .e-checkbox-wrapper {
  visibility: visible;
}

.e-control.e-filemanager .e-grid .e-row.e-fe-drop-file:hover .e-checkbox-wrapper {
  visibility: hidden;
}

.e-control.e-filemanager .e-grid.e-horizontallines .e-rowcell.e-lastrowcell, .e-control.e-filemanager .e-grid.e-verticallines .e-rowcell.e-lastrowcell, .e-control.e-filemanager .e-grid.e-hidelines .e-rowcell.e-lastrowcell {
  border-bottom-width: 0;
}

.e-control.e-filemanager .e-grid.e-resize-lines .e-headercell .e-rsuppress {
  border-width: 0;
}

.e-control.e-filemanager .e-grid .e-fe-icon {
  display: inline-block;
  height: 18px;
  margin: 0 8px 0 0;
...
.e-control.e-filemanager .e-dialog td {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
  font-size: 14px;
...
.e-control.e-filemanager .e-dialog td.e-fe-value {
  white-space: unset;
  word-break: break-word;
}

.e-control.e-filemanager .e-dialog .e-fe-errorcontent {
  white-space: normal;
  word-break: break-all;
}

.e-control.e-filemanager .e-dialog .e-fe-retrycontent {
  padding: 16px 0;
}

.e-control.e-filemanager .e-dialog .e-image {
  height: 100%;
  width: 100%;
}

.e-control.e-filemanager .e-dialog.e-rtl td {
  padding: 8px 0 8px 24px;
}

.e-control.e-filemanager .e-large-icons {
  float: left;
  overflow: auto;
  width: 100%;
}

.e-control.e-filemanager .e-large-icons .e-checkbox-wrapper .e-frame {
  border-width: 1px;
  line-height: 10px;
}

.e-control.e-filemanager .e-large-icons .e-empty {
  min-width: 200px;
}

.e-control.e-filemanager .e-large-icons .e-empty-content {
  font-size: 20px;
  margin: 0 auto;
  padding: 8px;
  text-align: center;
...
.e-control.e-filemanager .e-large-icons .e-empty-icon {
  height: 52px;
  margin: 0 auto;
  width: 52px;
}

.e-control.e-filemanager .e-large-icons .e-empty-inner-content {
  font-size: 14px;
  margin: 0 auto;
  opacity: 0.5;
  padding: 6px;
...
.e-control.e-filemanager .e-large-icons .e-list-parent {
  display: block;
  height: 100%;
  margin: 0;
  overflow: auto;
...
.e-control.e-filemanager .e-large-icons .e-checkbox-wrapper {
  float: left;
  position: absolute;
  top: 0;
  visibility: hidden;
...
.e-control.e-filemanager .e-large-icons .e-list-item {
  border: 1px solid;
  float: left;
  height: 85px;
  margin: 8px 4px;
...
.e-control.e-filemanager .e-large-icons .e-list-item.e-active .e-checkbox-wrapper, .e-control.e-filemanager .e-large-icons .e-list-item.e-hover .e-checkbox-wrapper {
  visibility: visible;
}

.e-control.e-filemanager .e-large-icons .e-text-content {
  display: table-cell;
  height: 79px;
  position: relative;
...
.e-control.e-filemanager .e-large-icons .e-list-text {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
  display: block;
...
.e-control.e-filemanager .e-large-icons .e-list-img {
  border: 2px solid;
...
.e-control.e-filemanager .e-large-icons .e-list-icon {
  display: block;
  height: 40px;
  margin: 10px auto;
  width: 40px;
...
.e-control.e-filemanager .e-fe-error {
  font-size: 12px;
  line-height: 1.5;
}

.e-control.e-filemanager .e-fe-clone {
  pointer-events: none;
  z-index: 20;
}

.e-control.e-filemanager .e-fe-clone .e-fe-content {
  border: none;
...
.e-control.e-filemanager .e-fe-clone .e-fe-content .e-fe-name {
  display: inline-block;
  font-size: 13px;
  margin: auto 8px;
  max-width: 70px;
...
.e-control.e-filemanager .e-fe-clone .e-fe-content .e-fe-icon {
  display: inline-block;
  height: 18px;
  margin: auto 8px;
  width: 18px;
...
.e-control.e-filemanager .e-fe-clone .e-fe-count {
  border: 1px solid;
  border-radius: 50%;
  font-size: 12px;
  height: 22px;
...
.e-control.e-filemanager.e-rtl .e-treeview > .e-ul {
  padding: 0 8px 0 0;
}

.e-control.e-filemanager.e-rtl .e-toolbar .e-fe-grid {
  display: inline-table;
  transform: rotate(180deg);
}

.e-control.e-filemanager.e-rtl .e-splitter.e-splitter-horizontal {
  -ms-flex-direction: row-reverse;
  flex-direction: row-reverse;
}

.e-control.e-filemanager.e-rtl .e-address .e-search-wrap {
  float: left;
  left: 0;
  right: auto;
}

.e-control.e-filemanager.e-rtl .e-address .e-search-wrap .e-input-group .e-input {
  margin: 0 24px 0 0;
  padding: 0;
}

.e-control.e-filemanager.e-rtl .e-address .e-addressbar-ul {
  display: -ms-flexbox;
  display: flex;
}

.e-control.e-filemanager.e-rtl .e-address .e-addressbar-ul .e-icons::before {
  display: inline-block;
  transform: rotate(180deg);
}

.e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-row.e-focused td:first-child {
  box-shadow: inset -1px 1px 0 0 #66afe9, inset -1px -1px 0 0 #66afe9;
}

.e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-row.e-focused td:last-child {
  box-shadow: inset 1px 1px 0 0 #66afe9, inset 1px -1px 0 0 #66afe9;
}

.e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-gridheader .e-fe-checkbox, .e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-gridcontent .e-fe-checkbox {
  padding-left: 0;
  padding-right: 12px;
}

.e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-gridheader .e-fe-grid-icon, .e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-gridcontent .e-fe-grid-icon {
  padding-left: 0;
  padding-right: 12px;
}

.e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-gridheader .e-fe-grid-icon + .e-rowcell, .e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-gridheader .e-fe-grid-icon + .e-headercell, .e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-gridcontent .e-fe-grid-icon + .e-rowcell, .e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-gridcontent .e-fe-grid-icon + .e-headercell {
  padding-left: 21px;
  padding-right: 0;
}

.e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-gridheader .e-fe-grid-icon + .e-rowcell.e-fe-grid-name, .e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-gridheader .e-fe-grid-icon + .e-headercell.e-fe-grid-name, .e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-gridcontent .e-fe-grid-icon + .e-rowcell.e-fe-grid-name, .e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-gridcontent .e-fe-grid-icon + .e-headercell.e-fe-grid-name {
  padding-right: 12px;
}

.e-control.e-filemanager.e-rtl .e-grid.e-rtl .e-fe-icon {
  margin: 0 0 0 8px;
}

.e-control.e-filemanager.e-rtl .e-large-icons .e-list-item {
  float: right;
}

.e-control.e-filemanager.e-rtl .e-fe-clone .e-fe-count {
  margin-left: 0;
  margin-right: -12px;
}

.e-control.e-filemanager .e-upload {
  border-bottom-width: 0;
  border-top-width: 0;
}

.e-control.e-filemanager .e-upload .e-file-select-wrap {
  display: none;
}

.e-control.e-filemanager .e-upload .e-icons.e-file-delete-btn {
  display: none;
}

.e-control.e-filemanager .e-upload .e-upload-actions {
  border-bottom: 1px solid;
}

.e-control.e-filemanager .e-layout-content {
  position: relative;
}

.e-control.e-filemanager .e-fe-overlay {
...
.e-control.e-filemanager .e-upload-drag-hover {
  outline: none;
}

.e-control.e-filemanager .e-upload-drag-hover .e-fe-overlay {
  visibility: visible;
}

.e-control.e-filemanager .e-dialog.e-popup.e-dlg-resizable {
  min-height: 200px;
}

.e-control.e-fe-popup.e-dropdown-popup ul .e-item .e-fe-dot, .e-control.e-fe-popup.e-dropdown-popup ul .e-item .e-fe-tick, .e-control.e-fe-popup.e-contextmenu-wrapper ul .e-menu-item .e-fe-dot, .e-control.e-fe-popup.e-contextmenu-wrapper ul .e-menu-item .e-fe-tick {
  font-size: 14px;
}

.e-control.e-fe-popup.e-dlg-resizable .e-dlg-content {
  overflow: hidden;
}

.e-control.e-fe-popup.e-contextmenu-wrapper ul .e-menu-item.e-separator {
  margin: 0 0;
}

.e-control.e-fe-popup.e-rtl .e-fe-grid {
  display: inline-table;
  transform: rotate(180deg);
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar-items .e-toolbar-item .e-btn-icon.e-icons, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar-items .e-toolbar-item .e-btn-icon.e-icons, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar-items .e-toolbar-item .e-btn-icon.e-icons {
  font-size: 20px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-newfolder, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-newfolder, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-newfolder {
  padding-top: 0;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-upload, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-upload, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-upload {
  padding-left: 0;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-sort, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-sort, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-sort {
  padding-top: 3px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-refresh, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-refresh, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-refresh {
  padding-top: 3px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-select, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-select, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-select {
  padding-top: 2px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-large, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-large, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-large {
  padding: 4px 0 0 2px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-grid, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-grid, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-grid {
  padding: 4px 2px 0 2px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-details, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-details, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-details {
  padding-top: 3px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-delete, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-delete, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-delete {
  padding-left: 4px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-rename, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-rename, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-rename {
  padding-left: 2px;
  padding-top: 3px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-download, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-download, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-download {
  padding-left: 4px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-cut, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-cut, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-cut {
  padding-left: 2px;
  padding-top: 1px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-copy, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-copy, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-toolbar-items .e-toolbar-item.e-popup-text .e-tbar-btn.e-btn.e-tbtn-txt .e-icons.e-btn-icon.e-fe-copy {
  padding-left: 4px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar .e-popup-up-icon.e-icons, .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-popup-down-icon.e-icons, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-popup-up-icon.e-icons, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar .e-popup-down-icon.e-icons, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-popup-up-icon.e-icons, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar .e-popup-down-icon.e-icons {
  font-size: 20px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar-left .e-icons.e-fe-sort, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar-left .e-icons.e-fe-sort, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar-left .e-icons.e-fe-sort {
  display: inline-block;
  margin: 0;
  width: 14px;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar-left .e-tbar-ddb-text, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar-left .e-tbar-ddb-text, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar-left .e-tbar-ddb-text {
  display: none;
}

.e-control.e-filemanager.e-fe-mobile .e-toolbar-left .e-toolbar-item .e-tbar-btn-text, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-toolbar-left .e-toolbar-item .e-tbar-btn-text, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-toolbar-left .e-toolbar-item .e-tbar-btn-text {
  display: none;
}

.e-control.e-filemanager.e-fe-mobile .e-splitter .e-split-bar, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-splitter .e-split-bar, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-splitter .e-split-bar {
  display: none;
}

.e-control.e-filemanager.e-fe-mobile .e-address, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-address, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-address {
  height: 40px;
}

.e-control.e-filemanager.e-fe-mobile .e-address .e-addressbar-ul, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-address .e-addressbar-ul, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-address .e-addressbar-ul {
  height: 40px;
}

.e-control.e-filemanager.e-fe-mobile .e-address .e-address-list-item .e-icons, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-address .e-address-list-item .e-icons, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-address .e-address-list-item .e-icons {
  font-size: 10px;
}

.e-control.e-filemanager.e-fe-mobile .e-address .e-list-text, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-address .e-list-text, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-address .e-list-text {
  font-size: 16px;
}

.e-control.e-filemanager.e-fe-mobile .e-address .e-search-wrap, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-address .e-search-wrap, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-address .e-search-wrap {
  min-width: 47px;
  width: auto;
}

.e-control.e-filemanager.e-fe-mobile .e-address .e-search-wrap .e-input-group, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-address .e-search-wrap .e-input-group, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-address .e-search-wrap .e-input-group {
  display: none;
  height: 40px;
  width: 100%;
}

.e-control.e-filemanager.e-fe-mobile .e-address .e-search-wrap .e-input-group .e-clear-icon, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-address .e-search-wrap .e-input-group .e-clear-icon, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-address .e-search-wrap .e-input-group .e-clear-icon {
  margin: 2px 8px 0;
}

.e-control.e-filemanager.e-fe-mobile .e-address .e-search-wrap .e-input-group .e-input, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-address .e-search-wrap .e-input-group .e-input, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-address .e-search-wrap .e-input-group .e-input {
  margin: -2px 0 0 24px;
}

.e-control.e-filemanager.e-fe-mobile .e-address .e-fe-search, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-address .e-fe-search, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-address .e-fe-search {
  font-size: 20px;
  margin: 3px 0;
  right: 13px;
}

.e-control.e-filemanager.e-fe-mobile .e-dialog td.e-fe-value, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-dialog td.e-fe-value, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-dialog td.e-fe-value {
  white-space: unset;
  word-break: break-word;
}

.e-control.e-filemanager.e-fe-mobile .e-grid .e-fe-grid-icon .e-fe-icon, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-grid .e-fe-grid-icon .e-fe-icon, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-grid .e-fe-grid-icon .e-fe-icon {
  height: 35px;
  width: 35px;
}

.e-control.e-filemanager.e-fe-mobile .e-grid .e-gridheader, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-grid .e-gridheader, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-grid .e-gridheader {
  display: none;
}

.e-control.e-filemanager.e-fe-mobile .e-grid .e-content .e-rowcell, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-grid .e-content .e-rowcell, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-grid .e-content .e-rowcell {
  border-bottom: 1px solid;
  border-bottom-color: #dee2e6;
}

.e-control.e-filemanager.e-fe-mobile .e-grid .e-content .e-rowcell.e-fe-checkbox, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-grid .e-content .e-rowcell.e-fe-checkbox, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-grid .e-content .e-rowcell.e-fe-checkbox {
  padding: 0;
}

.e-control.e-filemanager.e-fe-mobile .e-grid .e-gridcontent .e-fe-grid-icon, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-grid .e-gridcontent .e-fe-grid-icon, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-grid .e-gridcontent .e-fe-grid-icon {
  padding-left: 10px;
  padding-right: 10px;
}

.e-control.e-filemanager.e-fe-mobile .e-grid .e-fe-text, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-grid .e-fe-text, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-grid .e-fe-text {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
}

.e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-large-icons .e-list-parent {
  padding: 0;
}

.e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-large-icons .e-list-parent .e-list-item {
  display: inline-table;
  height: 155px;
  margin: 12px 8px;
  width: 155px;
...
.e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item.e-hover .e-checkbox-wrapper, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item.e-hover .e-checkbox-wrapper, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-large-icons .e-list-parent .e-list-item.e-hover .e-checkbox-wrapper {
  visibility: hidden;
}

.e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item.e-active .e-checkbox-wrapper, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item.e-active .e-checkbox-wrapper, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-large-icons .e-list-parent .e-list-item.e-active .e-checkbox-wrapper {
  visibility: visible;
}

.e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item .e-checkbox-wrapper, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item .e-checkbox-wrapper, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-large-icons .e-list-parent .e-list-item .e-checkbox-wrapper {
  z-index: 1000;
}

.e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item .e-list-text, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item .e-list-text, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-large-icons .e-list-parent .e-list-item .e-list-text {
  margin: 0 auto;
  width: 110px;
}

.e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item .e-list-img, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item .e-list-img, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-large-icons .e-list-parent .e-list-item .e-list-img {
  margin: 11px auto;
  max-height: 110px;
  max-width: 110px;
}

.e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item .e-list-icon, .e-bigger .e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item .e-list-icon, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-large-icons .e-list-parent .e-list-item .e-list-icon {
  height: 110px;
  margin: 11px auto 0;
  width: 110px;
}

.e-control.e-filemanager.e-fe-m-select .e-large-icons .e-list-item.e-large-icon .e-checkbox-wrapper, .e-bigger .e-control.e-filemanager.e-fe-m-select .e-large-icons .e-list-item.e-large-icon .e-checkbox-wrapper, .e-control.e-filemanager.e-bigger.e-fe-m-select .e-large-icons .e-list-item.e-large-icon .e-checkbox-wrapper {
  visibility: visible;
}

.e-control.e-filemanager.e-fe-m-select .e-grid .e-content .e-row .e-rowcell .e-checkbox-wrapper, .e-bigger .e-control.e-filemanager.e-fe-m-select .e-grid .e-content .e-row .e-rowcell .e-checkbox-wrapper, .e-control.e-filemanager.e-bigger.e-fe-m-select .e-grid .e-content .e-row .e-rowcell .e-checkbox-wrapper {
  visibility: visible;
}

.e-control.e-filemanager.e-fe-m-filter .e-address .e-search-wrap, .e-bigger .e-control.e-filemanager.e-fe-m-filter .e-address .e-search-wrap, .e-control.e-filemanager.e-bigger.e-fe-m-filter .e-address .e-search-wrap {
  margin: 0;
  padding: 0;
  position: absolute;
  width: 100%;
...
.e-control.e-filemanager.e-fe-m-filter .e-address .e-search-wrap .e-input-group, .e-bigger .e-control.e-filemanager.e-fe-m-filter .e-address .e-search-wrap .e-input-group, .e-control.e-filemanager.e-bigger.e-fe-m-filter .e-address .e-search-wrap .e-input-group {
  display: -ms-inline-flexbox;
  display: inline-flex;
}

.e-control.e-filemanager.e-fe-m-filter .e-address .e-search-wrap .e-input-group .e-input, .e-bigger .e-control.e-filemanager.e-fe-m-filter .e-address .e-search-wrap .e-input-group .e-input, .e-control.e-filemanager.e-bigger.e-fe-m-filter .e-address .e-search-wrap .e-input-group .e-input {
  height: auto;
  margin-left: 45px;
}

.e-control.e-filemanager.e-fe-m-filter .e-address .e-search-wrap .e-fe-search, .e-bigger .e-control.e-filemanager.e-fe-m-filter .e-address .e-search-wrap .e-fe-search, .e-control.e-filemanager.e-bigger.e-fe-m-filter .e-address .e-search-wrap .e-fe-search {
  left: 0;
  margin-left: 8px;
  margin-top: 3px;
  width: 30px;
...
.e-control.e-filemanager.e-fe-m-filter .e-address .e-addressbar-ul, .e-bigger .e-control.e-filemanager.e-fe-m-filter .e-address .e-addressbar-ul, .e-control.e-filemanager.e-bigger.e-fe-m-filter .e-address .e-addressbar-ul {
  visibility: hidden;
}

.e-control.e-filemanager.e-fe-m-filter.e-rtl .e-address .e-search-wrap .e-input-group .e-input, .e-bigger .e-control.e-filemanager.e-fe-m-filter.e-rtl .e-address .e-search-wrap .e-input-group .e-input, .e-control.e-filemanager.e-bigger.e-fe-m-filter.e-rtl .e-address .e-search-wrap .e-input-group .e-input {
  margin-right: 45px;
}

.e-control.e-filemanager.e-fe-m-filter.e-rtl .e-address .e-search-wrap .e-fe-search, .e-bigger .e-control.e-filemanager.e-fe-m-filter.e-rtl .e-address .e-search-wrap .e-fe-search, .e-control.e-filemanager.e-bigger.e-fe-m-filter.e-rtl .e-address .e-search-wrap .e-fe-search {
  transform: rotate(180deg);
}

.e-control.e-filemanager.e-rtl .e-grid .e-gridheader .e-fe-grid-icon, .e-control.e-filemanager.e-rtl .e-grid .e-gridcontent .e-fe-grid-icon, .e-bigger .e-control.e-filemanager.e-rtl .e-grid .e-gridheader .e-fe-grid-icon, .e-bigger .e-control.e-filemanager.e-rtl .e-grid .e-gridcontent .e-fe-grid-icon, .e-control.e-filemanager.e-bigger.e-rtl .e-grid .e-gridheader .e-fe-grid-icon, .e-control.e-filemanager.e-bigger.e-rtl .e-grid .e-gridcontent .e-fe-grid-icon {
  padding-right: 10px;
}

.e-bigger .e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-btn-icon.e-icons, .e-control.e-filemanager.e-bigger .e-toolbar .e-toolbar-items .e-toolbar-item .e-btn-icon.e-icons {
  font-size: 20px;
}

.e-bigger .e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn, .e-control.e-filemanager.e-bigger .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn {
  padding: 1px 7px;
}

.e-bigger .e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn.e-active, .e-control.e-filemanager.e-bigger .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn.e-active {
  padding: 1px 7px;
}

.e-bigger .e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn:hover, .e-control.e-filemanager.e-bigger .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn:hover {
  padding: 1px 7px;
}

.e-bigger .e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn:focus, .e-control.e-filemanager.e-bigger .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn:focus {
  padding: 1px 7px;
}

.e-bigger .e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn .e-btn-icon.e-icons.e-caret, .e-control.e-filemanager.e-bigger .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn .e-btn-icon.e-icons.e-caret {
  padding: 0 10px;
}

.e-bigger .e-control.e-filemanager .e-toolbar .e-toolbar-pop .e-toolbar-item .e-dropdown-btn .e-btn-icon.e-icons.e-caret, .e-control.e-filemanager.e-bigger .e-toolbar .e-toolbar-pop .e-toolbar-item .e-dropdown-btn .e-btn-icon.e-icons.e-caret {
  padding: 0 10px;
}

.e-bigger .e-control.e-filemanager .e-toolbar .e-popup-up-icon.e-icons, .e-bigger .e-control.e-filemanager .e-toolbar .e-popup-down-icon.e-icons, .e-control.e-filemanager.e-bigger .e-toolbar .e-popup-up-icon.e-icons, .e-control.e-filemanager.e-bigger .e-toolbar .e-popup-down-icon.e-icons {
  font-size: 20px;
}

.e-bigger .e-control.e-filemanager .e-treeview > .e-ul, .e-control.e-filemanager.e-bigger .e-treeview > .e-ul {
  padding-left: 12px;
}

.e-bigger .e-control.e-filemanager .e-treeview .e-list-parent .e-list-item .e-fullrow, .e-control.e-filemanager.e-bigger .e-treeview .e-list-parent .e-list-item .e-fullrow {
  height: 40px;
}

.e-bigger .e-control.e-filemanager .e-treeview .e-list-parent .e-list-item .e-list-text, .e-control.e-filemanager.e-bigger .e-treeview .e-list-parent .e-list-item .e-list-text {
  height: 38px;
  line-height: 38px;
}

.e-bigger .e-control.e-filemanager .e-address, .e-control.e-filemanager.e-bigger .e-address {
  height: 40px;
}

.e-bigger .e-control.e-filemanager .e-address .e-breadcrumb-menu .e-breadcrumb-submenu, .e-control.e-filemanager.e-bigger .e-address .e-breadcrumb-menu .e-breadcrumb-submenu {
  height: 33px;
}

.e-bigger .e-control.e-filemanager .e-address .e-address-list-item, .e-control.e-filemanager.e-bigger .e-address .e-address-list-item {
  height: 34px;
}

.e-bigger .e-control.e-filemanager .e-address .e-address-list-item .e-icons, .e-control.e-filemanager.e-bigger .e-address .e-address-list-item .e-icons {
  font-size: 10px;
}

.e-bigger .e-control.e-filemanager .e-address .e-addressbar-ul, .e-control.e-filemanager.e-bigger .e-address .e-addressbar-ul {
  padding: 3px 12px;
}

.e-bigger .e-control.e-filemanager .e-address .e-list-text, .e-control.e-filemanager.e-bigger .e-address .e-list-text {
  font-size: 16px;
  line-height: 32px;
  padding: 5px 4px;
}

.e-bigger .e-control.e-filemanager .e-address .e-search-wrap, .e-control.e-filemanager.e-bigger .e-address .e-search-wrap {
  min-width: 51px;
  padding: 1.5px 12px 0 1px;
}

.e-bigger .e-control.e-filemanager .e-address .e-search-wrap .e-input-group, .e-control.e-filemanager.e-bigger .e-address .e-search-wrap .e-input-group {
  height: 36px;
}

.e-bigger .e-control.e-filemanager .e-address .e-search-wrap .e-input-group .e-input:focus, .e-control.e-filemanager.e-bigger .e-address .e-search-wrap .e-input-group .e-input:focus {
  padding: 0;
}

.e-bigger .e-control.e-filemanager .e-address .e-fe-search, .e-control.e-filemanager.e-bigger .e-address .e-fe-search {
  margin: 7px 0;
}

.e-bigger .e-control.e-filemanager .e-grid .e-checkbox-wrapper .e-frame, .e-control.e-filemanager.e-bigger .e-grid .e-checkbox-wrapper .e-frame {
  border-width: 1px;
  line-height: 13px;
}

.e-bigger .e-control.e-filemanager .e-grid .e-headercell, .e-control.e-filemanager.e-bigger .e-grid .e-headercell {
  height: 36px;
}

.e-bigger .e-control.e-filemanager .e-grid .e-headertext, .e-control.e-filemanager.e-bigger .e-grid .e-headertext {
  font-size: 15px;
}

.e-bigger .e-control.e-filemanager .e-grid .e-gridheader .e-rowcell, .e-bigger .e-control.e-filemanager .e-grid .e-gridcontent .e-rowcell, .e-control.e-filemanager.e-bigger .e-grid .e-gridheader .e-rowcell, .e-control.e-filemanager.e-bigger .e-grid .e-gridcontent .e-rowcell {
  font-size: 13px;
}

.e-bigger .e-control.e-filemanager .e-grid .e-gridheader .e-rowcell .e-fe-text, .e-bigger .e-control.e-filemanager .e-grid .e-gridcontent .e-rowcell .e-fe-text, .e-control.e-filemanager.e-bigger .e-grid .e-gridheader .e-rowcell .e-fe-text, .e-control.e-filemanager.e-bigger .e-grid .e-gridcontent .e-rowcell .e-fe-text {
  font-size: 14px;
}

.e-bigger .e-control.e-filemanager .e-grid .e-gridheader .e-fe-checkbox, .e-bigger .e-control.e-filemanager .e-grid .e-gridcontent .e-fe-checkbox, .e-control.e-filemanager.e-bigger .e-grid .e-gridheader .e-fe-checkbox, .e-control.e-filemanager.e-bigger .e-grid .e-gridcontent .e-fe-checkbox {
  padding-left: 16px;
}

.e-bigger .e-control.e-filemanager .e-grid .e-gridheader .e-fe-grid-icon, .e-bigger .e-control.e-filemanager .e-grid .e-gridcontent .e-fe-grid-icon, .e-control.e-filemanager.e-bigger .e-grid .e-gridheader .e-fe-grid-icon, .e-control.e-filemanager.e-bigger .e-grid .e-gridcontent .e-fe-grid-icon {
  padding-left: 16px;
}

.e-bigger .e-control.e-filemanager .e-grid .e-fe-icon, .e-control.e-filemanager.e-bigger .e-grid .e-fe-icon {
  margin: 0 12px 0 0;
}

.e-bigger .e-control.e-filemanager .e-grid .e-empty, .e-control.e-filemanager.e-bigger .e-grid .e-empty {
  min-width: 300px;
}

.e-bigger .e-control.e-filemanager .e-grid .e-empty-content, .e-control.e-filemanager.e-bigger .e-grid .e-empty-content {
  font-size: 24px;
  margin: 0 auto;
  padding: 12px;
  text-align: center;
...
.e-bigger .e-control.e-filemanager .e-grid .e-empty-icon, .e-control.e-filemanager.e-bigger .e-grid .e-empty-icon {
  height: 64px;
  margin: 0 auto;
  width: 64px;
}

.e-bigger .e-control.e-filemanager .e-grid .e-empty-inner-content, .e-control.e-filemanager.e-bigger .e-grid .e-empty-inner-content {
  font-size: 16px;
  margin: 0 auto;
  opacity: 0.5;
  padding: 6px;
...
.e-bigger .e-control.e-filemanager .e-dialog .e-dlg-header-content, .e-control.e-filemanager.e-bigger .e-dialog .e-dlg-header-content {
  padding: 21px;
}

.e-bigger .e-control.e-filemanager .e-dialog td, .e-control.e-filemanager.e-bigger .e-dialog td {
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
  font-size: 15px;
...
.e-bigger .e-control.e-filemanager .e-large-icons .e-checkbox-wrapper .e-frame, .e-control.e-filemanager.e-bigger .e-large-icons .e-checkbox-wrapper .e-frame {
  border-width: 1px;
  line-height: 13px;
}

.e-bigger .e-control.e-filemanager .e-large-icons .e-list-parent, .e-control.e-filemanager.e-bigger .e-large-icons .e-list-parent {
  padding: 0 6px;
}

.e-bigger .e-control.e-filemanager .e-large-icons .e-list-item, .e-control.e-filemanager.e-bigger .e-large-icons .e-list-item {
  height: 106px;
  margin: 12px 6px;
  width: 100px;
}

.e-bigger .e-control.e-filemanager .e-large-icons .e-text-content, .e-control.e-filemanager.e-bigger .e-large-icons .e-text-content {
  height: 100px;
}

.e-bigger .e-control.e-filemanager .e-large-icons .e-list-text, .e-control.e-filemanager.e-bigger .e-large-icons .e-list-text {
  font-size: 14px;
  padding: 4px 2px 2px;
  width: 94px;
}

.e-bigger .e-control.e-filemanager .e-large-icons .e-list-img, .e-control.e-filemanager.e-bigger .e-large-icons .e-list-img {
  max-height: 79px;
  max-width: 94px;
}

.e-bigger .e-control.e-filemanager .e-large-icons .e-list-icon, .e-control.e-filemanager.e-bigger .e-large-icons .e-list-icon {
  height: 52px;
  margin: 11px auto;
  width: 52px;
}

.e-bigger .e-control.e-filemanager .e-large-icons .e-empty, .e-control.e-filemanager.e-bigger .e-large-icons .e-empty {
  min-width: 300px;
}

.e-bigger .e-control.e-filemanager .e-large-icons .e-empty-content, .e-control.e-filemanager.e-bigger .e-large-icons .e-empty-content {
  font-size: 24px;
  margin: 0 auto;
  padding: 12px;
  text-align: center;
...
.e-bigger .e-control.e-filemanager .e-large-icons .e-empty-icon, .e-control.e-filemanager.e-bigger .e-large-icons .e-empty-icon {
  height: 64px;
  margin: 0 auto;
  width: 64px;
}

.e-bigger .e-control.e-filemanager .e-large-icons .e-empty-inner-content, .e-control.e-filemanager.e-bigger .e-large-icons .e-empty-inner-content {
  font-size: 16px;
  margin: 0 auto;
  opacity: 0.5;
  padding: 6px;
...
.e-bigger .e-control.e-filemanager.e-rtl .e-treeview > .e-ul, .e-control.e-filemanager.e-bigger.e-rtl .e-treeview > .e-ul {
  padding: 0 12px 0 0;
}

.e-bigger .e-control.e-filemanager.e-rtl .e-grid .e-gridheader .e-fe-checkbox, .e-bigger .e-control.e-filemanager.e-rtl .e-grid .e-gridcontent .e-fe-checkbox, .e-control.e-filemanager.e-bigger.e-rtl .e-grid .e-gridheader .e-fe-checkbox, .e-control.e-filemanager.e-bigger.e-rtl .e-grid .e-gridcontent .e-fe-checkbox {
  padding-right: 16px;
}

.e-bigger .e-control.e-filemanager .e-fe-overlay, .e-control.e-filemanager.e-bigger .e-fe-overlay {
  height: calc(100% - 41px);
}

@media (max-width: 469px) {
  .e-bigger .e-control.e-filemanager.e-fe-mobile .e-large-icons .e-list-parent .e-list-item, .e-control.e-filemanager.e-bigger.e-fe-mobile .e-large-icons .e-list-parent .e-list-item {
    min-width: 140px;
    width: calc(50% - 17px);
  }
}
...
.e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn.e-active .e-btn-icon, .e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn.e-active .e-tbar-btn-text {
  color: #fff;
}
...
.e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn:focus .e-btn-icon, .e-control.e-filemanager .e-toolbar .e-toolbar-items .e-toolbar-item .e-dropdown-btn.e-btn.e-tbar-btn:focus .e-tbar-btn-text {
  color: #fff;
}
...
.e-control.e-filemanager .e-address .e-breadcrumb-menu .e-breadcrumb-submenu:active .e-btn-icon, .e-control.e-filemanager .e-address .e-breadcrumb-menu .e-breadcrumb-submenu:active .e-tbar-btn-text, .e-control.e-filemanager .e-address .e-breadcrumb-menu .e-breadcrumb-submenu:focus .e-btn-icon, .e-control.e-filemanager .e-address .e-breadcrumb-menu .e-breadcrumb-submenu:focus .e-tbar-btn-text, .e-control.e-filemanager .e-address .e-breadcrumb-menu .e-breadcrumb-submenu:hover .e-btn-icon, .e-control.e-filemanager .e-address .e-breadcrumb-menu .e-breadcrumb-submenu:hover .e-tbar-btn-text {
  color: #fff;
}

.e-control.e-filemanager .e-address .e-icons {
  color: #495057;
}
...
.e-control.e-filemanager .e-address .e-address-list-item:focus .e-list-text {
  background: #fff;
  color: #0056b3;
}
...
.e-control.e-filemanager .e-address .e-address-list-item:not(:last-child) .e-list-text:hover {
  background: #fff;
  color: #0056b3;
}

.e-control.e-filemanager .e-address .e-address-list-item:not(:last-child) .e-list-text:active {
  background: #fff;
  color: #0056b3;
}

.e-control.e-filemanager .e-address .e-address-list-item:not(:last-child) .e-list-text:focus {
  background: #fff;
  color: #0056b3;
}

.e-control.e-filemanager .e-address .e-search-wrap .e-input-group.e-control-wrapper:not(.e-success) {
  background: #fff;
  border-color: #dee2e6;
}

.e-control.e-filemanager .e-treeview .e-list-item.e-active > .e-fullrow {
  border: #007bff;
}

.e-control.e-filemanager .e-treeview .e-list-parent .e-list-item.e-fe-drop-folder.e-hover > .e-fullrow {
  border-color: #007bff;
}

.e-control.e-filemanager .e-grid .e-gridheader tr:first-child th {
  background: #fff;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-headercell:not(.e-fe-grid-icon):hover {
  background: #f2f4f6;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-headercell.e-fe-checkbox:hover {
  background: #fff;
}

.e-control.e-filemanager .e-grid .e-gridheader .e-headercell.e-fe-grid-icon .e-headercelldiv:hover {
  background: #f2f4f6;
}

.e-control.e-filemanager .e-grid td.e-active {
  background-color: #007bff;
  color: #fff;
}

.e-control.e-filemanager .e-grid .e-checkbox-wrapper .e-icons.e-check {
  background-color: #fff;
  color: #212529;
}

.e-control.e-filemanager .e-grid .e-checkbox-wrapper .e-icons.e-stop {
  background-color: #fff;
  color: #212529;
}

.e-control.e-filemanager .e-grid.e-gridhover tr[role='row'].e-fe-drop-file:not(.e-editedrow):hover .e-rowcell:not(.e-cellselectionbackground):not(.e-active):not(.e-updatedtd):not(.e-indentcell) {
...
.e-control.e-filemanager .e-dialog td:first-child {
  color: #6c757d;
}
...
.e-control.e-filemanager .e-large-icons .e-active {
  color: #fff;
}

.e-control.e-filemanager .e-large-icons .e-large-icon {
  border-color: transparent;
}

.e-control.e-filemanager .e-large-icons .e-large-icon.e-active {
  background: #007bff;
  border-color: #007bff;
}

.e-control.e-filemanager .e-large-icons .e-large-icon.e-hover {
  background: #f2f4f6;
  border-color: #f2f4f6;
}

.e-control.e-filemanager .e-large-icons .e-large-icon.e-active.e-hover {
  background: #007bff;
  border-color: #007bff;
}

.e-control.e-filemanager .e-large-icons .e-large-icon.e-focus {
  border-color: #f2f4f6;
}

.e-control.e-filemanager .e-large-icons .e-large-icon.e-hover.e-fe-drop-folder {
  border-color: #007bff;
}

.e-control.e-filemanager .e-large-icons .e-checkbox-wrapper .e-icons.e-check {
  background-color: #fff;
  color: #212529;
}
...
.e-control.e-filemanager.e-fe-mobile .e-large-icons .e-large-icon.e-hover {
  background: transparent;
  border-color: transparent;
}

.e-control.e-filemanager.e-fe-mobile .e-large-icons .e-large-icon.e-focus {
  border-color: transparent;
}

.e-control.e-filemanager.e-fe-mobile .e-large-icons .e-large-icon.e-active {
  background: #007bff;
  border-color: #007bff;
}
...
.e-control.e-fe-popup.e-dropdown-popup ul .e-item.e-separator, .e-control.e-fe-popup.e-contextmenu-wrapper ul .e-menu-item.e-separator {
