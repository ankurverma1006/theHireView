...
.e-float-input.e-input-group.e-small:not(.e-float-icon-left):not(.e-input-group.e-disabled) .e-input-group-icon:last-child:hover, .e-float-input.e-control-wrapper.e-input-group.e-small:not(.e-float-icon-left):not(.e-input-group.e-disabled) .e-input-group-icon:last-child:hover {
  -moz-box-sizing: border-box;
  -webkit-box-sizing: border-box;
  border-width: 0px 1px 0px 1px;
  box-sizing: border-box;
...
.e-input + .e-input-group-icon:not(.e-input-group.e-float-icon-left):last-child:hover, .e-input-group.e-success .e-input + .e-input-group-icon:last-child:hover, .e-input-group.e-success.e-control-wrapper .e-input + .e-input-group-icon:last-child:hover {
  border-color: #2bc700;
}
