...
.e-sort-ddb .e-sort-icon::before, .e-spreadsheet-contextmenu .e-sort-icon::before {
  content: '\e734';
}

.e-sort-ddb .e-sort-asc::before, .e-spreadsheet-contextmenu .e-sort-asc::before {
  content: '\e734';
}

.e-sort-ddb .e-sort-desc::before, .e-spreadsheet-contextmenu .e-sort-desc::before {
  content: '\e733';
}

.e-sort-ddb .e-sort-custom::before, .e-spreadsheet-contextmenu .e-sort-custom::before {
  content: '\e732';
}
...
.e-spreadsheet.e-hide-row-header .e-column-header, .e-spreadsheet.e-hide-row-header .e-main-content {
  width: 100% !important;
}
...
.e-spreadsheet .e-main-panel .e-row.e-hide {
  height: 0 !important;
}
...
.e-spreadsheet .e-main-content .e-table .e-zero .e-cell, .e-spreadsheet .e-main-content .e-table .e-zero-start .e-cell, .e-spreadsheet .e-main-content .e-table .e-zero-end .e-cell {
  border-bottom-width: 0;
}

.e-spreadsheet .e-column-header .e-table tr .e-header-cell.e-col-resize {
  cursor: col-resize;
}

.e-spreadsheet .e-row-header .e-table tr .e-header-cell.e-row-resize {
  cursor: row-resize;
}
...
.e-spreadsheet .e-sheet colgroup .e-hide {
  width: 0 !important;
}
...
.e-spreadsheet .e-main-content .e-table, .e-spreadsheet .e-column-header .e-table {
  width: 100%;
}
...
.e-spreadsheet .e-sheet-tab.e-tab .e-tab-header .e-toolbar-item:nth-child(2) {
...
.e-sort-dialog .e-sort-error, .e-sort-dialog .e-sort-header, .e-sort-dialog .e-sort-listsection {
  padding-left: 18px;
  padding-right: 18px;
}
...
.e-spreadsheet .e-sheet-tab-panel .e-btn.e-flat.e-icon-btn, .e-spreadsheet .e-sheet-tab-panel .e-aggregate-list.e-flat {
  border-color: transparent;
  box-shadow: none;
}

.e-spreadsheet .e-sheet-tab-panel .e-btn.e-flat.e-icon-btn .e-btn-icon, .e-spreadsheet .e-sheet-tab-panel .e-aggregate-list.e-flat .e-btn-icon {
  color: rgba(0, 0, 0, 0.54);
}

.e-spreadsheet .e-sheets-list, .e-spreadsheet .e-aggregate-list, .e-spreadsheet .e-add-sheet-tab.e-flat {
...
.e-spreadsheet .e-row-header .e-prev-highlight .e-header-cell, .e-spreadsheet .e-row-header .e-header-cell.e-highlight, .e-spreadsheet .e-select-all-cell.e-prev-highlight-bottom {
