...
var yearDropDownVisibility = false;
var _typeof =
...
var YearDropdownOptions = (function(_React$Component) {
  ...
  function YearDropdownOptions(props) {
    ...
    _this.shiftYears = function(amount) {
      console.log('shift years ', amount);
    ...
    _this.incrementYears = function() {
      console.log('increament years es');
      console.log('_this.state.yearsList ', _this.state.yearsList);
      return _this.shiftYears(10);
    };

    _this.decrementYears = function() {
      console.log('decrement years es');
      console.log('_this.state.yearsList ', _this.state.yearsList);
      return _this.shiftYears(-10);
    };
    ...
    return (
      ...
      (_this.toggleDropdown = function(event) {
        _this.setState(
          ...
          function() {
            console.log(_this.state.dropdownVisible, 'shoe dropdown of years');

            yearDropDownVisibility = true;
...
var Calendar = (function(_React$Component) {
  ...
  function Calendar(props) {
    ...
    _this.yearNextTenIncrement = function() {
      console.log('yearNextTenIncrement');
      _this.setState({
        yearDropDownVisibility: !_this.state.yearDropDownVisibility
      });
    };
    ...
    _this.increaseYear = function() {
      _this.setState(
        {
          date: addMonths(cloneDate(_this.state.date), 12)
        },
        function() {
          return _this.handleMonthChange(_this.state.date);
        }
    ...
    _this.increaseYearCustom = function() {
      _this.setState(
        {
          date: addMonths(cloneDate(_this.state.date), 12)
        },
    ...
    _this.decreaseYear = function() {
      _this.setState(
        {
          date: subtractMonths(cloneDate(_this.state.date), 12)
        },
        function() {
          return _this.handleMonthChange(_this.state.date);
        }
    ...
    _this.renderPreviousYearButton = function() {
      ...
      if (yearDropDownVisibility === true) clickHandler = _this.decrementYears;
    ...
    _this.renderNextYearButton = function() {
      ...
      if (yearDropDownVisibility === true)
        clickHandler = _this.yearNextTenIncrement;

      console.log('clickHandler', yearDropDownVisibility, _this);
