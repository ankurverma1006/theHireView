...
class addOnlineProfile extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
  ...
  handleSubmit() {
    ...
    let profileTitle = this.state.profileTitle;
    let url = this.state.url;
    let description = this.state.description;

    let onlineProfile = [];
    if (accomplishmentId) onlineProfile = accomplishmentData.onlineProfile;
    ...
    accomplishmentData.onlineProfile = onlineProfile;
            ...
            <Form horizontal className="lightBgForm">
              <Col sm={10}>
                <FormGroup
                  ...
                  className={this.getClasses('profileTitle')}
                >
                  <Col componentClass={ControlLabel} sm={3}>
                    <ControlLabel>Profile Title</ControlLabel>
                  </Col>
                  <Col sm={9}>
                    <FormControl
                    ...
                    />
                    {renderMessage(
                      this.props.getValidationMessages('profileTitle')
                    )}
                  </Col>
                </FormGroup>
...
addOnlineProfile = validation(strategy)(addOnlineProfile);
