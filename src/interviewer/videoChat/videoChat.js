...
import PeerConnection from '../../common/videoChat/PeerConnection';

import CallWindow from '../../common/videoChat/CallWindow';
import classnames from 'classnames';
import { connect } from 'react-redux';
//import { captureUserMedia, S3Upload } from './AppUtils';
import RecordRTC from 'recordrtc';
...
class VideoChat extends Component {
  ...
  endCall(isStarter) {
    if (this.multiStreamRecorder) this.multiStreamRecorder.stopRecording();
    if (_.isFunction(this.pc.stop)) this.pc.stop(isStarter);
    this.pc = {};
    //  this.config = null;
    this.setState({
