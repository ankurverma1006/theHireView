...
class EditProfile extends Component {
  ...
  getEmploymentData(userId){
    spikeViewApiService('getEmploymentListById',{userId})
    .then(response => { 
  ...
  getProjectsData(userId){
    spikeViewApiService('getProjectListById',{userId})
    .then(response => {     
      if (response.data.status === 'Success') {
  ...
  getCareerProfileData(userId){
    spikeViewApiService('getDesiredProfileListById',{userId})
    .then(response => {     
      if (response.data.status === 'Success') {
  ...
  handleImageChange = (action, event) => {
    ...
    .then(data => {
      ...
      this.props.actionUpdateUserInfo({ profilePicture });
      spikeViewApiService('updateProfileImage', profileData);    
  ...
  uploadFiles= event => {
    ...
    .then(data => {
      ...
      console.log(data);
      spikeViewApiService('addResume',sendData)
      .then(response => {     
        if (response.data.status === 'Success') {
